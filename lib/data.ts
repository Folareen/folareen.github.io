...
export const projects: Project[] = [
    ...
    },
    {
        ...
        description:
            "A blogging platform where anyone can read and publish, with a rich editor, image uploads, and a reading experience that gets out of the way.",
...
export const workEntries: WorkEntry[] = [
    {
        ...
        note: "High ownership, working directly with the founder, from feature scoping to shipping.",
        ...
        products: [
            {
                ...
                detail:
                    "Designed and built the entire backend from scratch for a pilot scheduling and swap platform, using Node.js, TypeScript, Express, and MySQL on AWS. Designed the matching algorithm that pairs pilots and flight attendants for schedule swaps, built an end-to-end chat system on Socket.io, and automated schedule data extraction from flica.net with Puppeteer. Also handled frontend integration, wiring the client to these APIs and fixing issues on that side.",
            },
        ],
    },
    {
